    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.hitung) {
            ...
            if (!isEmptyFields && !isInvalidDouble) {
                JajarGenjang hitungJajarGenjang = new JajarGenjang();
                hitungJajarGenjang.setAlas(alas);
                hitungJajarGenjang.setTinggi(tinggi);

                Double hasil = hitungJajarGenjang.luas();
