    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.hitung) {
            ...
            if (!isEmptyFields && !isInvalidDouble) {
                LayangLayang hitungLayangLayang = new LayangLayang();
                hitungLayangLayang.setDiagonal1(diagonal1);
                hitungLayangLayang.setDiagonal2(diagonal2);

                Double hasil = hitungLayangLayang.luas();
